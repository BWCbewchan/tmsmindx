...
const migrations: Migration[] = [
  ...
  {
    name: 'V107_portfolios_drop_student_id_not_null',
    version: 107,
    sql: `
      DO $$
      BEGIN
  ...
  {
    name: 'V108_quan_ly_qc_teacher_account_and_scaled_score',
    version: 108,
    sql: `
  ...
  {
    name: 'V109_k12_leader_documents',
    version: 109,
    sql: `
